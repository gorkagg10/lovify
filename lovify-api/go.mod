...
require (
	...
	github.com/gorkagg10/lovify/lovify-matching-service v0.0.0-20250718125310-4c896a797bae
	github.com/gorkagg10/lovify/lovify-user-service v0.0.0-20250717211827-da5b8800d754
	github.com/rs/cors v1.11.1
	google.golang.org/grpc v1.73.0
)

require github.com/gorkagg10/lovify/lovify-messaging-service v0.0.0-20250718132513-91083ebfc5a1 // indirect
